...
pub const GRADUATE_FEE: u64 = 5_000_000_0; // 5 SOL
pub const VIRT_SOL_RESERVE: u64 = 24_000_000_0; // 24 SOL
pub const REAL_SOL_THRESHOLD: u64 = 100_000_000_0; // 95 + 5 SOL (GRADUATE_FEE) calculated at $200 sol price
